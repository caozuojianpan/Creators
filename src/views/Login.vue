  ...
  <div>
    ...
    <form class="mui-input-group">
      ...
      <div class="mui-button-row">
        <button type="button" data-loading-icon-position="right" class="mui-btn btn mui-btn-success" @click="tap">确认
        </button>

        <button type="button" class="mui-btn mui-btn-danger" @click="register">注册</button>
      </div>
      <div class="mui-button-row">
        <button type="button" data-loading-icon-position="right" class="mui-btn btn1" @click="tap1">切换登录方式</button>
